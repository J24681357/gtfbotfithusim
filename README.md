...
5. In most menus, you can see information about your game status on the bottom of the embed. As detailed from left-right:
   - Number of gifts (Can be redeemable in **/gifts**). Note this does not appear when you have no gifts.
   - Credit balance
   - Experience level
   - Experience points
   - Amount of miles for the Daily Workout. When you reach 26.219 miles or 42.195 km, you can earn a daily workout prize by using **/daily**. This resets every 24 hours. You can adjust the timezones by using **/settings Time Zone Setting**.
...
2. The amount of experience points you earn is based on the event's difficulty, the type of mode, and finishing position.
...
2. Although you can take license tests at your own pace, your performance in license tests depends on your driver level. The higher the driver level, the easier you will be able to complete the license tests and vice versa.
    - Take a look at the recommended driver levels for each license in the manual.
4. In each license menu, there are a list of license tests you are able to take. You can complete them in any order that you choose.
...
5. After you have started in the pre session screen, you will see the following:
    - Progress bar (Time remaining is hidden in license tests)
    - Gold, Silver, & Bronze times in the license tests
    - Best Lap
    - Lap Times (Will be updated after completing 1 lap)
6. Every time that you complete a license test will count as 1 lap and the game will restart the license test.
    - The session ends if the lap time achieved Gold, or if more than 5 laps are completed.
...
2. Speed tests are run in real time so longer lengths will take longer to find the top speed.
3. When a speed test is finished, the top speed is recorded in the results screen.
...
3. Selecting a car in this menu will bring up the car details, performance specs, damage conditions and other details about the car. As detailed:
